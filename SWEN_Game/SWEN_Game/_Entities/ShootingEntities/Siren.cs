...
{
    public class Siren : Enemy, IBulletShooter
    {
        private float shootCooldown = 1f;  // seconds
        private float shootTimer = 0f;
        private List<Bullet> enemyBullets = new();

        public Siren(Vector2 spawnPosition)
        {
            ...
            Texture = Globals.Content.Load<Texture2D>("Sprites/Entities/Enemies/Sirena");
        ...
        private void ShootAtPlayer(IEnemyContext enemyManager)
        {
            ...
            Animation anim = new Animation(
                Globals.Content.Load<Texture2D>("Sprites/Bullets/FlameBullet"),
                1,
                4,
                0.1f,
                16,
